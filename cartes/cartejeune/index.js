class CarteJeune {
    ...
    getSvgCardFace() {
        ...
        return new Promise((resolve, reject) => {
            fetch("https://cdn.githubraw.com/andronedev/extension_papillon_wallet/master/master/cartes/cartejeune/cartejeunev1_face.svg").then(response => response.text()).then(svg => {
    ...
    getSvgCardBack() {
        const self = this;
        return new Promise((resolve, reject) => {
            fetch("https://cdn.githubraw.com/andronedev/extension_papillon_wallet/master/master/cartes/cartejeune/cartejeunev1_back.svg").then(response => response.text()).then(svg => { // replace el_annee_haut, el_annee_bas
    ...
    getSvgPreview() {
        const self = this;
        return new Promise((resolve, reject) => {
            fetch("https://cdn.githubraw.com/andronedev/extension_papillon_wallet/master/master/cartes/cartejeune/cartejeunev1_preview.svg").then(response => response.text()).then(svg => { // replace el_nom, el_prenom, el_etab, el_num_top, el_code
                resolve(svg);
            });
        });
    }
